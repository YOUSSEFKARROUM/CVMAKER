  ...
  ({ cvData, settings, className = '' }, ref) => {
    ...
    return (
      ...
      >
        ...
        {orderedSections.map((section: LayoutSectionId) => {
          if (section === 'profile' && profile) {
            return (
              <div className="mb-8" key="profile">
                <SectionTitle titleKey="template.profile" color={settings.primaryColor} variant="underline" className="uppercase" />
          ...
          if (section === 'experience' && experiences.length > 0) {
            return (
              <div className="mb-8" key="experience">
                <SectionTitle titleKey="template.experience" color={settings.primaryColor} variant="underline" className="uppercase" />
          ...
          if (section === 'education' && educations.length > 0) {
            return (
              <div className="mb-8" key="education">
                <SectionTitle titleKey="template.education" color={settings.primaryColor} variant="underline" className="uppercase" />
          ...
          if (section === 'languages' && languages.length > 0) {
            return (
              <div className="mb-8" key="languages">
                <SectionTitle titleKey="template.languages" color={settings.primaryColor} variant="underline" className="uppercase" />
                <div className="grid grid-cols-3 gap-4">
                  {languages.map((lang) => (
          ...
          if (section === 'certifications' && certifications.length > 0) {
            return (
              <div className="mb-8" key="certifications">
                <SectionTitle titleKey="template.certifications" color={settings.primaryColor} variant="underline" className="uppercase" />
                <div className="space-y-3">
          ...
          if (section === 'projects' && projects.length > 0) {
            return (
              <div className="mb-8" key="projects">
                <SectionTitle titleKey="template.projects" color={settings.primaryColor} variant="underline" className="uppercase" />
                <div className="space-y-4">
                  {projects.map((proj) => (
